...
interface ModalConfirmPushDatasetProps {
  visible: boolean
  onApply?: () => void
  onCancel?: () => void
  title?: string
...
const ModalConfirmPushDataset: React.FC<React.PropsWithChildren<ModalConfirmPushDatasetProps>> = ({
  visible,
  onApply,
  onCancel,
  title
...
export default ModalConfirmPushDataset
