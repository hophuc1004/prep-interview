...
interface ModalProps {
  ...
  paddingYContent?: string // New prop for custom padding
}
...
const CustomModal: React.FC<React.PropsWithChildren<ModalProps>> = ({
  ...
  paddingYContent = 'py-6' // Default padding value
}) => {
  if (!visible) {
    return null
  }
    ...
    >
      ...
      >
        ...
        <div
          ...
          className={classnames('flex-[1_1_auto] rounded-lg', paddingX, paddingYContent)}
        >
          {children}
        </div>
